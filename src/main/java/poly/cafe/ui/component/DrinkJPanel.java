...
public class DrinkJPanel extends javax.swing.JPanel {
    ...
    private void lblImageMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblImageMouseClicked
        ...
        if (imageClicked != null && drink != null) {
    ...
    public void setDrink(Drink drink) {
        ...
        lblImage.setText("");
        String imagePath = "images/" + drink.getImage(); // Giả định ảnh trong thư mục images
        try {
            lblImage.setIcon(XIcon.getIcon(imagePath, width, height));
        } catch (Exception e) {
            System.out.println("Error loading drink image: " + e.getMessage());
            lblImage.setIcon(null);
            lblImage.setText("No Image");
        }
    }
